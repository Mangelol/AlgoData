...
public class Main {
	...
	public static void main(String[] args) {
		...
		int size = 39293;
		NoBucketsHashTable hash = new NoBucketsHashTable("postnummer.csv");
		...
		System.out.println(hash.linearLookUp(11115));
		System.out.println(hash.linearLookUp(17165));
		System.out.println(hash.linearLookUp(96128));		
		System.out.println(hash.linearLookUp(172637)); //Denna är inte från filen	
		System.out.println(" ");
